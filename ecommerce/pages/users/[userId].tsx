...
const UserInfoForm = () => {
  ...
  return (
    <formik.Form>
      <widgets.TextField name="name" label="Full Name" fullWidth={true} />
      <widgets.TextField disabled name="email" label="Email Address" fullWidth={true} />
      <widgets.TextField name="contactNo" label="Mobile Number" fullWidth={true} />
      ...
      <widgets.TextField name="accountNo" label="Account Number" fullWidth={true} />
      <widgets.TextField
        disabled
        name="balance"
        ...
        fullWidth={true}
      />
      <widgets.TextField name="secret" label="Secret Key" fullWidth={true} />
