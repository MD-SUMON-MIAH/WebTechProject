...
const AddressInfoForm = () => {
  ...
  return (
    <formik.Form>
      <widgets.TextField name="city" label="Enter District" fullWidth />
      <widgets.TextField name="area" label="Area/Road No" fullWidth multiline />
      <widgets.TextField name="houseNo" label="House Number" fullWidth multiline />
      <widgets.TextField name="phone" label="Mobile No" fullWidth />
